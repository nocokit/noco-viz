...
export const officialTemplates = [
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-business-dashboard.jpg',
  ...
  },
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-factory-monitoring.jpg',
  ...
  },
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-security-monitoring.jpg',
    resolution: '1920 x 1080',
    usageCount: 1200,
    category: 'security',
    tags: ['安全', 'SOC', '态势感知'],
  ...
  },
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-supply-chain.jpg',
    resolution: '1920 x 1080',
    usageCount: 680,
    category: 'logistics',
    tags: ['供应链', '物流', '库存'],
  ...
  },
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-hr-dashboard.jpg',
    resolution: '1920 x 1080',
    usageCount: 920,
    category: 'hr',
    tags: ['人力资源', 'HR', '招聘'],
  ...
  },
  {
    ...
    type: 'official',
    isSystem: true,
    thumbnail: '/uploads/templates/template-customer-service.jpg',
    resolution: '1920 x 1080',
    usageCount: 540,
    category: 'service',
    tags: ['客服', '工单', '满意度'],
...
export const sharedTemplates = [
  {
    ...
    isSystem: false,
    department: '销售部',
    thumbnail: '/uploads/templates/template-sales-weekly.jpg',
    resolution: '1920 x 1080',
    usageCount: 120,
    category: 'sales',
    tags: ['销售', '周报', 'KPI'],
  ...
  },
  {
    ...
    isSystem: false,
    department: 'UI设计部',
    thumbnail: '/uploads/templates/template-minimal-charts.jpg',
    resolution: '自适应',
    usageCount: 560,
    category: 'design',
    tags: ['UI', '图表', '极简'],
  ...
  },
  {
    ...
    isSystem: false,
    department: '技术部',
    thumbnail: '/uploads/templates/template-dev-efficiency.jpg',
    resolution: '1920 x 1080',
    usageCount: 340,
  ...
  },
  {
    ...
    isSystem: false,
    department: '市场部',
    thumbnail: '/uploads/templates/template-marketing-monitor.jpg',
    resolution: '1920 x 1080',
    usageCount: 280,
    category: 'marketing',
    tags: ['营销', 'ROI', '转化率'],
  ...
  },
  {
    ...
    isSystem: false,
    department: '财务部',
    thumbnail: '/uploads/templates/template-finance-monthly.jpg',
    resolution: '1920 x 1080',
    usageCount: 195,
    category: 'finance',
    tags: ['财务', '月报', '利润'],
